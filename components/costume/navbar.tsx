    ...
    return (
        <div className="flex items-center justify-between px-4 md:px-6 lg:px-4 sticky
            ...
            <div className="flex gap-2 items-center">
                ...
                <a href={"https://gdg.community.dev/events/details/google-gdg-constantine-presents-devfest-constantine-2025/"} className="hidden md:flex cursor-pointer" target="_blank" rel="noopener noreferrer">
            ...
            <div className={`lg:hidden absolute top-full left-0 w-full bg-white dark:bg-black border-b border-gray-200 dark:border-gray-800
                ...
                <nav className="flex flex-col p-4 space-y-2 instrument-sans-regular">
                    ...
                    <div className="pt-2 space-y-2">
                        ...
                        {/* Mobile CTA */}
                        <a href="https://gdg.community.dev/events/details/google-gdg-constantine-presents-devfest-constantine-2025/" className="cursor-pointer" target="_blank" rel="noopener noreferrer">
